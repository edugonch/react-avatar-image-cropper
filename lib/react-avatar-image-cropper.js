...
var AvatarImageCropper = function (_Component2) {
    ...
    function AvatarImageCropper(props) {
        ...
        _this2.sliderDiv = { height: '20px', margin: '5px', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' };
        _this2.btnStyle = {
            display: 'inline-block',
            fontSize: '14px',
            fontWeight: 400,
        ...
        _this2.resetOrientation = function (file) {
        ...
        _this2.onDrop = function (evt) {
            ...
            if (ifImage && file.size <= maxsize) {
                ...
                _this2.resetOrientation(file).then(function (file) {
